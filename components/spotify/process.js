			...
			<SRLWrapper options={options}>
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							My process began with research to understand
							podcasts as a listening experience and an industry.
						</Text>
						<Text>
							I conducted semi-structured user interviews and
							explored large-scale podcast behaviors through a
							literature review.
						</Text>
						<Text>
							Then, I conducted a heuristic evaluation of Spotify
							and examined the industry with a competitive
							analysis of podcast apps.
						</Text>
					</StickyBox>
					<HalfSticky>
						<Img
						...
						<div>
							...
							<Caption>
								Interviewing a close friend who listens to
								podcasts
							</Caption>
						</div>
						<div>
							...
							<CaptionTwo>
								Examining types of Spotify screens and the
								podcast flow
							</CaptionTwo>
						</div>
						<div>
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							From my research, I learned that podcasts are
							wonderful to listen to and are a part of peoples'
							daily routine. However, it's hard for listeners to
						...
						<UL>
							...
							<Li>
								Users don’t browse through podcasts on Spotify
							</Li>
							<Li>
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							...
							scope. I wanted to help listeners discover new
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							After defining the problem, I went to the drawing
							board. I explored many different apps and websites
							such as YouTube, Twitter, etc. to see how they help
							users discover new things.
						</Text>
						<Text>
							With a variety of ideas, I scoped down by conducting
							an effort impact analysis. My top three ideas were a
							ratings and review system, showing friends' podcast
							activities, and a featured podcast section with
							curated articles.
						</Text>
					</StickyBox>
					<HalfSticky>
				...
				<FlexTwo>
					<Box>
						...
						<Text>
							...
							Podcasts because it has the best opportunity to
							guide users to browse in Spotify, doesn't interrupt
							users' listening experience, and can provide the
							most information about a podcast.
						</Text>
					</Box>
					<HalfSticky>
						<Img
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							...
							information architecture. Some key decisions I had
							to figure out was where would the featured section
							live on the podcast page, how much information would
							be in an article, and what kind of actions can users
							expect to see.
						</Text>
					</StickyBox>
					<HalfSticky>
				...
				<FlexTwo>
					<Box>
						...
						<Text>
							I went into high-fidelity prototyping soon after
							because of time constraints. For visual design, I
							tried my best to align myself with Spotify's design
							principles.
						</Text>
					</Box>
					<HalfSticky>
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							Although I couldn't schedule any formal usability
							tests, I was able to receive feedback from users
							throughout designing my prototype.
						</Text>
						<Text>
							I made several decisions and changes from the
							feedback such as creating a new component for
							soundbites, utilizing multiple types of cards to
							draw attention, and cutting down on content for
							users to easily skim.
						</Text>
					</StickyBox>
					<HalfSticky>
						<Img
				...
				<FlexTwo>
					<StickyBox>
						...
						<Text>
							After these fun 8 weeks, here's my final design. A
							fresh redesign of the podcasts home page with
							eye-catching cards that lead to insightful articles.
						</Text>
					</StickyBox>
					<HalfSticky>
						<Img
				...
				<FlexTwo>
					<Box>
						...
						<Text>
							At the end of my 8 weeks, I presented this project
							to the Applied 2020 community. I received
							recognition for having great visual design,
							presentation and storytelling, and won the
							audience's favorite for my presentation session.
						</Text>
						<Text>
							<A
				...
				<FlexTwo>
					<Div>
						...
						<Text>
							...
							work on because I had to dive into an unknown
							product, design system, and problem space. I learned
							so much in this project and here are some of my key
							takeaways.
						</Text>
						<Subheader>Iterate, iterate, iterate</Subheader>
						<Text>
							It’s important to continue thinking outside and
							inside the box at every step of the design process.
							Being open-minded helped me go through many ideas
							and find the best solution at each step.
						</Text>
						<Subheader>
						...
						<Text>
							...
							feasible, impactful solution to the problem instead
							of designing a brand new, sky-high experience like
							many of my course projects.
						</Text>
						<Subheader>Feedback is always valuable</Subheader>
						<Text>
							Within the 8 weeks, it was difficult to conduct a
							lot of formal usability and a/b testing. But, being
							able to reach out and just ask for small feedback
							helped me throughout the process immensely.
						</Text>
						<br />
						<Text>
							Thanks to the{' '}
							...
							appreciate my buddies, mentors, and fellow designers
							for their wonderful feedback on this project.
						</Text>
					</Div>
				</FlexTwo>
		</div>
